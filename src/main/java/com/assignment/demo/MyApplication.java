...
import com.assignment.demo.dao.EventDao;
import com.assignment.demo.domain.Event;
import com.assignment.demo.domain.EventConverter;
import com.assignment.demo.domain.EventDto;
...
import static com.assignment.demo.domain.EventDto.State.STARTED;
...
public class MyApplication implements CommandLineRunner {
	...
	@Autowired
	public MyApplication(ObjectMapper objectMapper, Connection connection, EventConverter eventConverter) {
	...
	public void run(String... args) throws IOException {
		...
		try(BufferedReader bufferedReader = new BufferedReader(new FileReader(filePath))) {
			bufferedReader.lines().forEach(this::convertCheckState);
	 ...
	 * @param json
	 */
	private void convertCheckState(String json) {
		try {
